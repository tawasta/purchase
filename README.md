...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/5533f4aeca2045459e731d58c9c324d4)](https://www.codacy.com/app/Tawasta/purchase?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=Tawasta/purchase&amp;utm_campaign=Badge_Grade)
...
[purchase_order_default_note](purchase_order_default_note/) | 10.0.1.0.0 | Add a default purchase note for partner
...
[purchase_order_filter_scheduled_date](purchase_order_filter_scheduled_date/) | 10.0.1.0.0 | Scheduled Date Filters to Purchases
...
[purchase_order_no_open_form](purchase_order_no_open_form/) | 10.0.1.0.0 | This module prevents to open forms on specified fields.
...
[purchase_order_select_tax](purchase_order_select_tax/) | 10.0.1.0.0 | Select tax from dropdpwn-menu for Purchase Order Lines
...
[purchase_order_tree_reference](purchase_order_tree_reference/) | 10.0.1.0.0 | Add reference-field on Purchase Order tree view
...
[purchase_request_line_both_codes_in_description](purchase_request_line_both_codes_in_description/) | 10.0.1.0.0 | Show both codes in Purchase Request line description field
...
[purchase_request_supplier_stored](purchase_request_supplier_stored/) | 10.0.1.0.0 | New field for indicating what AA the PR is related to
