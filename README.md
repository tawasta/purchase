...
[![Pre-commit Status](https://github.com/tawasta/purchase/actions/workflows/pre-commit.yml/badge.svg?branch=17.0)](https://github.com/tawasta/purchase/actions/workflows/pre-commit.yml?query=branch%3A17.0)
[![Build Status](https://github.com/tawasta/purchase/actions/workflows/test.yml/badge.svg?branch=17.0)](https://github.com/tawasta/purchase/actions/workflows/test.yml?query=branch%3A17.0)
...
[purchase_order_po_sent_status](purchase_order_po_sent_status/) | 17.0.1.1.0 |  | Add PO Sent status to Purchase Orders
...
[purchase_report_incoterm_full_name](purchase_report_incoterm_full_name/) | 17.0.1.0.0 |  | Shows Incoterm full name instead of code on Purchase Report
...
[purchase_report_line_product_internal_reference](purchase_report_line_product_internal_reference/) | 17.0.1.0.1 |  | Purchase Order reports - Product's internal reference
...
[purchase_report_manufacturer_code](purchase_report_manufacturer_code/) | 17.0.1.0.1 |  | Adds manufacturer code to PO and RFQ lines
[purchase_report_mto_sale_delivery_address](purchase_report_mto_sale_delivery_address/) | 17.0.1.0.1 |  | Related sale delivery address is shown on purchase print
[purchase_report_order_reference](purchase_report_order_reference/) | 17.0.1.0.0 |  | Add PO order reference to header informations
[purchase_report_orderlines](purchase_report_orderlines/) | 17.0.1.1.4 |  | Fixes orderlines in purchase report
...
[purchase_report_quantity_decimals](purchase_report_quantity_decimals/) | 17.0.1.0.0 |  | Modifications to Purchase Report' decimal precision
...
[purchase_request_check_stock_availability](purchase_request_check_stock_availability/) | 17.0.2.4.3 |  | Trigger internal transfers from Purchase Request view
...
[purchase_request_moves_use_internal_notes](purchase_request_moves_use_internal_notes/) | 17.0.1.0.0 |  | PQ – Disable sending automatic e-mails from stock moves
...
[purchase_request_status_message](purchase_request_status_message/) | 17.0.1.0.1 |  | Send a message after Purchase Request is approved, rejected or approval is requested
