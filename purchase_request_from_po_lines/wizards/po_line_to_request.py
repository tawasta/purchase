...
class PoLineToRequest(models.TransientModel):
    ...
    def onchange_type(self):
        ...
        if self.type == "latest_own":
            ...
            if not res:
                ...
                self.type = "new"
                txt = _(
                    "You don't have any Purchase Requests "
    ...
    def create_purchase_request(self):
        ...
        if self.type == "new":
            pr_vals = {"description": _("Created from Purchase Order Lines")}
        ...
        for po_line in purchase_order_line_model.browse(self.env.context["active_ids"]):
    ...
    redirect_to_purchase_request = fields.Boolean(
        string="Show Purchase Request Form", default=False
    )
    ...
    date_start = fields.Date(
        related="purchase_request_id.date_start", string="Creation date", readonly=True
    )
    description = fields.Text(
        related="purchase_request_id.description", string="Description", readonly=True
    )
